    ...
    >
      <div className="text-center max-w-xl mx-auto mb-10">
        ...
        <p className="text-lg text-[#0C2E3A] leading-relaxed">
          Our approach combines meaningful connections, practical skills
          development, and access to opportunities to empower women at every
          stage of their journey. Together, these pillars create lasting
          pathways toward confidence, independence, and sustainable growth.
        </p>
      </div>

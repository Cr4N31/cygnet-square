    ...
    <section className="bg-base rounded-t-xl px-6 sm:px-10 lg:px-12 pt-16 pb-12 grid md:grid-cols-2 grid-cols-1 gap-10 items-center">
      ...
      <div data-aos="fade-up">
        ...
        <p className="text-lg text-white/60 leading-relaxed mb-6">
          By combining a supportive, community-driven approach with modern
          tools, we empower women to build independent, safe and financially
          secure lives while fostering meaningful connections that promote
        ...
        <div className="grid grid-cols-2 gap-2.5">
          {stats.map(({ icon, label, value }) => (
            ...
            >
              <i
                className={`ti ${icon} text-gold-dark text-lg mb-2 block`}
                aria-hidden="true"
              />

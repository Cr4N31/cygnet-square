...
function Events() {
  const events = [
    ...
    },
    {
      ...
      description:
        "A candid conversation featuring BIPOC women leaders sharing stories of resilience, advocacy, and economic empowerment...",
    },
    {
      tag: "Networking",
      bgColor: "bg-gold",
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-10 items-center mb-10">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-lg text-white/60 leading-relaxed">
            ...
            through mentorship programs, peer support circles, networking
            events, and community meetups that foster trust, collaboration, and
            personal growth.
          </p>
        </div>
      </div>
        ...
        {events.map(
          ({ tag, bgColor, icon: Icon, title, location, description }) => (
            ...
            >
              ...
              <div
                className={`${bgColor} h-40 relative flex flex-col items-center justify-center gap-3 overflow-hidden`}
              >
